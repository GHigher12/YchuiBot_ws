...
int main(int argc, char* argv[])
{
    ...
    ros::NodeHandle n;
    ros::Subscriber iat_text_sub =n.subscribe("/voice_detector", 1000,iattextCallback); //subscribe voice to text reault
	tts_text_pub = n.advertise<std_msgs::String>("/voice_creator", 1000);  //publish text to voice string
